...
public class FragmentRandom extends Fragment {
    ...
    private static final String[] colors = new String[]{"#ebe831","#b631eb","#eb31d5","#EA5E5E"};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button btnChange = view.findViewById(R.id.btnColourFragRandom);
        frameLayout = view.findViewById(R.id.fragRandom);
